...
def index(request):
	if request.method == 'POST':
		...
		Password=Usr.objects.make_random_password()

		user = Usr(FullName=FullName,UserType=UserType,UserCompany=UserCompany,Designation=Designation,EmailID=EmailID,Phone=Phone,Password=Password)
		user.save()
		print('user created')
